...
const giftAccounts: GiftAccount[] = [
  {
    ...
    accountHolder: "Nadia Utami",
  },
  {
    bankName: "Bank Mandiri",
    accountNumber: "9876-5432-1098",
    accountHolder: "Bagas Nugraha",
  },
];

const physicalAddress = "Jl. Mawar No. 789, Apt 12B, Tasikmalaya 12345";
      ...
      <div className="container max-w-3xl mx-auto px-6">
        ...
        >
          <p className="text-xs text-ink-muted italic">
            Dengan penuh rasa terima kasih, Nadia & Bagas
          </p>
        </motion.div>
      </div>
    </section>
