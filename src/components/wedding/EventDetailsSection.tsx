...
const EventCard = ({
  ...
  const addToCalendar = () => {
    const startDate = new Date("2026-02-14T14:00:00");
    const endDate = new Date("2026-02-14T23:00:00");
    
    const googleCalendarUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(
      `${title} - Pernikahan Nadia & Bagas`
      ...
      <div className="container max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          <EventCard
            ...
            time="08:00 WIB"
            venue="Masjid Agung Tasikmalaya"
            address="Jl. Mesjid Agung No.01, Yudanagara, Kec. Tawang, Kab. Tasikmalaya, Jawa Barat 46121"
            mapUrl="https://maps.app.goo.gl/pTARcePNzYDB3vHa6"
            delay={0.2}
          />
          <EventCard
            title="Resepsi"
            date="Sabtu, 14 Februari 2026"
            time="11:00 WIB"
            venue="Grand Asia Tasikmalaya"
            address="Jl. Lkr. Asia, Tuguraja, Kec. Cihideung, Kab. Tasikmalaya, Jawa Barat 46125"
            mapUrl="https://maps.app.goo.gl/CVv3dgJ29W3EHrpm8"
            delay={0.4}
          />
        </div>
      </div>
