...
import CouplePhoto1 from "../../../public/photos/prewed_1.png";
...
const CoverSection = ({ onOpen }: CoverSectionProps) => {
  ...
  const currentDate = new Date('2026-02-14T14:00:00').toLocaleDateString("id-ID", {
    weekday: "long",
    year: "numeric",
    month: "long",
    day: "numeric",
  ...
  const weddingDate = new Date("2026-02-14T14:00:00");
      ...
      {!isOpening && (
        ...
        >
          <div className="w-full max-w-5xl mx-auto px-4 py-6 md:py-8">
            ...
            >
              <span>Vol. MMXXVI • No. 621</span>
              <span>Edisi Khusus Pernikahan</span>
              <span>Kepada: <span className="font-semibold">{to}</span></span>
            </motion.div>
            ...
            >
              <div className="py-3 border-r border-ink">
                <p className="text-[10px] md:text-xs uppercase tracking-wider text-ink-muted">Resepsi</p>
                <p className="font-display text-sm md:text-lg font-bold text-ink">14 Februari 2026</p>
              </div>
              <div className="py-3 border-r border-ink">
                <p className="text-[10px] md:text-xs uppercase tracking-wider text-ink-muted">Waktu</p>
                <p className="font-display text-sm md:text-lg font-bold text-ink">11:00 WIB</p>
              </div>
              <div className="py-3">
                <p className="text-[10px] md:text-xs uppercase tracking-wider text-ink-muted">Tempat</p>
                <p className="font-display text-sm md:text-lg font-bold text-ink">Graha Asia</p>
              </div>
            </motion.div>
